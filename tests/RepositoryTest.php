...
namespace Jarhen\Modules\tests;

use Illuminate\Filesystem\Filesystem;
use Jarhen\Modules\Collection;
use Jarhen\Modules\Exceptions\InvalidAssetPath;
use Jarhen\Modules\Exceptions\ModuleNotFoundException;
...
class RepositoryTest extends BaseTestCase
{
    ...
    public function it_gets_the_configured_stubs_path_if_enabled()
    {
        ...
        $this->assertEquals(base_path('vendor/jarhen/codifire-modules/src/Commands/stubs'), $this->repository->getStubPath());
    }
