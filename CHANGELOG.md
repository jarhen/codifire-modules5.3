...
All Notable changes to `codifire-modules` will be documented in this file.
...
- Module generation namespace now works with `StudlyCase` ([Issue #14](https://github.com/nWidart/codifire-modules/issues/14))
